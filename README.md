...
This project investigates the claim that ensemble methods reduce variance while keeping bias constant. Some criterion for the project had to be fulfilled. The claim had to be tested using real world data. Ideally such a claim would be tested on simulate data. Also three diffrent methods had to be included when testing the claim. Lastly the report coul dbe no longer than 6 pages including figures and tables.
